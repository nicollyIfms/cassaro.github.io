...
/*SLIDE*/
  ...
  var posicaoTextoAtual = 0;
 
 //intervalo para execução da funcao mudarTexto
 setInterval(mudarTexto, 6500);  
  
 function mudarTexto(){
   var atual = posicaoTextoAtual;
   var proxima;
   ...
   textos[atual].style.opacity = '0';
   textos[proxima].style.opacity = '1';  
 };
 /*SLIDE*/
 ...
 /* TROCA DE PAGINAS */
  var linksMenu =  document.querySelectorAll('nav, main a'); 
